...
public class ShaderHelper {
    ...
    public static int loadShader(int type, String shaderSrc) {
        ...
        if (compiled[0] == 0) {
            Log.e("ShaderHelper", GLES30.glGetShaderInfoLog(shader));
    ...
    public static int loadProgram(String vertShaderSrc, String fragShaderSrc) {
        ...
        if (linked[0] == 0) {
            Log.e("ShaderHelper", "Error linking program:");
            Log.e("ShaderHelper", GLES30.glGetProgramInfoLog(programObject));
